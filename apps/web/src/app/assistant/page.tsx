    ...
    <>
      <section className="card">
        ...
        <p className="lede">
          ...
          Answers factual questions with document citations and refuses unapproved topics.
        </p>
        ...
        <div style={{ marginBottom: "1rem" }}>
          ...
          <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
            <button
              type="button"
              className="small"
              onClick={() => setPreset("What are the general building operating hours?")}
            >
            ...
            <button
              type="button"
              className="small"
              onClick={() => setPreset("What are the aircon temperature setpoints?")}
            >
            ...
            <button
              type="button"
              className="small"
              onClick={() => setPreset("What number should I call for an elevator breakdown?")}
            >
            ...
            <button
              type="button"
              className="small"
              onClick={() => setPreset("What is the secret wifi password on the 10th floor?")}
            >
            ...
            <button
              type="button"
              className="small"
              onClick={() => setPreset("There is water dripping from the ceiling near the lifts", "Level 2 Lobby")}
            >
        ...
        <form onSubmit={submit}>
          ...
          <div style={{ display: "flex", gap: "1rem", alignItems: "center", marginTop: "0.5rem" }}>
            <button type="submit" disabled={busy} style={{ width: "auto", padding: "0.5rem 1.5rem" }}>
        ...
        <section className="card">
          <div className="actions" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <span
              className="pill"
              style={{
                background: result.outcome === "FINALIZED" ? "#2e7d32" : "#e65100",
                color: "#fff",
              }}
            >
              {result.outcome}
          ...
          {result.reference_code && (
            <div style={{ margin: "0.5rem 0" }}>
              ...
              <code style={{ fontSize: "1rem", fontWeight: "bold" }}>{result.reference_code}</code>{" "}
          ...
          <p className="lede" style={{ marginTop: "0.75rem" }}>
            ...
            <Link href="/manager">Manager Queue</Link> or test raw vector similarities in the{" "}
            <Link href="/knowledge">Knowledge Studio</Link>.
          </p>
        </section>
      )}
    </>
