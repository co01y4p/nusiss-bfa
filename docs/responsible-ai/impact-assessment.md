...
| **7** | **Algorithmic Bias, Dialectal Penalization & Triage Inequity** | Requests from students or service staff are deprioritized over senior faculty for identical defects; colloquial Singapore English (Singlish) triggers false security quarantines or misclassification; barrier-free accessibility defects are downplayed as cosmetic. | **Counterfactual Parity Enforcement & Dialectal Robustness**: Explicit fairness and accessibility directives embedded in prompts (`priority/v1.yaml`, `classification/v1.yaml`). Deterministic security filters calibrated to achieve 0% Singlish false-positive rate. Evaluated via 24-case counterfactual Promptfoo benchmark maintaining Perturbation Invariance Rate $\ge 95\%$. | [`policies.py`](file:///Users/yeesheng/Documents/Coding/nusiss-bfa/apps/api/app/domain/incidents/policies.py), [`priority/v1.yaml`](file:///Users/yeesheng/Documents/Coding/nusiss-bfa/apps/api/app/prompts/priority/v1.yaml), [`test_bias_testing.py`](file:///Users/yeesheng/Documents/Coding/nusiss-bfa/apps/api/tests/test_bias_testing.py), [`bias-testing.md`](file:///Users/yeesheng/Documents/Coding/nusiss-bfa/docs/responsible-ai/bias-testing.md) |
